...
public class ViewTest2 extends ServletUtil {
	...
	private void getPage(HttpServletRequest req, HttpServletResponse resp)
		...
		reply
				.append("<h4>Select a Folder or Test, then Click the Details Button</h4>\n");
		reply
				.append("<form name=\"viewTest\" method=\"post\" onSubmit=\"return validateForm(this);\">\n");
		...
		adminHeader(req, resp, ServletUtil.VIEW_TEST_TREE_JS
