...
public class BarChart extends AbstractChart{
   ...
   protected AbstractDataset createDataset(ChartDataSet[] dataSets) {
	      DefaultCategoryDataset dataset = new DefaultCategoryDataset();
	      ...
	      for(ChartDataSet tpTeamDataSet : dataSets)
	      {
	    	  ...
	    	  ChartDataPoint tpTeamDataPoints = tpTeamDataSet.getChartDataPoints().get(0);
   ...
   public JFreeChart createChart(ChartDataSet[] dataSets, String projName) {
	      ...
	      // create the chart...
	      JFreeChart chart = ChartFactory.createBarChart("Project " + projName + " Users Overview", // title
	            "User", // domain axis label
	            "Number of Tests", // range axis label
	            dataset, // data
	            PlotOrientation.VERTICAL, // orientation
