...
public class ViewProject extends ServletUtil {
	...
	private String rowNameHeader = "<tr><form method=\"post\" action=\"viewProject2\"><th>Project</th><td>";
	...
	throws ServletException, IOException
	{		
		String reply = "<h4>View Project</h4>\n<table border=\"2\">" + mProjRows + "</table>";		
	...
	public static void main(String[] args)
	{
		...
		ViewProject servlet = new ViewProject();
