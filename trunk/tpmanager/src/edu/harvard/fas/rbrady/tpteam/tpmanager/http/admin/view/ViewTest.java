...
public class ViewTest extends ServletUtil {
	...
	private String rowNameHeader = "<tr><form method=\"post\" action=\"viewTest2\"><th align=\"left\">Project</th><td align=\"right\">";
	...
	throws ServletException, IOException
	{		
		String reply = "<h4>View Test Tree: Select Parent Project</h4>\n<table border=\"2\">" + mProjRows + "</table>";		
